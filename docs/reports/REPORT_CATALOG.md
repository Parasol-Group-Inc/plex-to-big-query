...
| Vox Scorecard \| Goals Table (`scorecard_goals`) | Reference data | ✅ Created 2026-09-04 in both datasets — fed from a Google Sheet, **not** the ETL | [scorecard_goals.md](scorecard_goals.md) |
...
| Goals \| Resolved (app first, sheet fallback) | Reference data | ✅ Built and verified 2026-09-09 — the migration seam between the goals web app and the spreadsheet ETL | [v2_scorecard_goals_resolved.md](v2_scorecard_goals_resolved.md) |
| Vox Scorecard \| Revenue vs Goal **(v2 goals)** | Sales | ✅ Deployed 2026-09-09 — generated copy of the original reading the resolver | [v2_scorecard_goals_resolved.md](v2_scorecard_goals_resolved.md) + [revenue_vs_goal_report.md](revenue_vs_goal_report.md) |
| Vox Scorecard \| Sales vs Goal by Rep **(v2 goals)** | Sales | ✅ Deployed 2026-09-09 — generated copy of the original reading the resolver | [v2_scorecard_goals_resolved.md](v2_scorecard_goals_resolved.md) + [sales_vs_goal_report.md](sales_vs_goal_report.md) |
| Vox Scorecard \| Production vs Goal **(v2 goals)** | Production | ✅ Deployed 2026-09-09 — generated copy of the original reading the resolver | [v2_scorecard_goals_resolved.md](v2_scorecard_goals_resolved.md) + [production_vs_goal_report.md](production_vs_goal_report.md) |
