...
| Label Design Queue | Sales | ✅ Deployed 2026-09-16 (verified queryable in both datasets) | [label_design_report.md](label_design_report.md) |
...
| Part On-Hand Inventory | Supply Chain | ✅ Built and verified against Plex’s Inventory Summary screen | [part_on_hand_inventory_report.md](part_on_hand_inventory_report.md) |
...
| Inventory \| Available to Sell (On-Hand less Demand) | Supply Chain | ✅ Built and verified 2026-09-09 | [inventory_available_to_sell_report.md](inventory_available_to_sell_report.md) |
| Vox Scorecard \| Out of Stock (33-parts) | Supply Chain | ✅ Rebuilt 2026-09-09 on release-based demand — awaiting first run with BOM data | [inventory_out_of_stock_report.md](inventory_out_of_stock_report.md) |
...
| Vox Scorecard \| Goals Table (`scorecard_goals`) | Reference data | 🗄 Legacy — created 2026-09-04, no longer pushed since 2026-09-22; its 68 goals imported into the Manual Data app (PlexTest, 2026-09-24); kept only as the resolver's fallback until retired | [scorecard_goals.md](scorecard_goals.md) |
| Turnaround standards (`turnaround_standards`) | Reference data | ✅ Created 2026-09-22 in both datasets — hand-maintained in BigQuery, **not** the ETL and **not** the web app. Empty in prod until the real figures are entered | [turnaround_standards.md](turnaround_standards.md) |
| Sales Reps (Inside Sales roster) | Sales | ✅ Deployed and verified 2026-09-22 — 13 reps, covering all 7 who carry a goal | [sales_reps_report.md](sales_reps_report.md) |
| Goals \| Resolved (app first, legacy fallback) | Reference data | ✅ Deployed — built 2026-09-09, renamed from `v2_scorecard_goals_resolved` 2026-09-22; the one goal list all three vs-goal reports read (Manual Data app first, legacy table as fallback) | [scorecard_goals_resolved.md](scorecard_goals_resolved.md) |
| Vox Scorecard \| Revenue vs Goal | Sales | ✅ Deployed and verified 2026-09-04 (both datasets); reads the goals resolver since 2026-09-22 | [revenue_vs_goal_report.md](revenue_vs_goal_report.md) |
| Vox Scorecard \| Sales vs Goal by Rep | Sales | ✅ Deployed and verified 2026-09-04 (both datasets); reads the goals resolver since 2026-09-22 | [sales_vs_goal_report.md](sales_vs_goal_report.md) |
| Vox Scorecard \| Production vs Goal | Production | ✅ Deployed and verified 2026-09-04 — 3,429 of 6,000 units (both datasets); reads the goals resolver since 2026-09-22 | [production_vs_goal_report.md](production_vs_goal_report.md) |
...
| Vox Scorecard \| NC Cost by Disposition (Destruction/Rework) | Quality | ✅ Deployed 2026-09-09 — 0 rows (quality tables empty), but the disposition value lists behind it are confirmed | [quality_disposition_cost_report.md](quality_disposition_cost_report.md) |
