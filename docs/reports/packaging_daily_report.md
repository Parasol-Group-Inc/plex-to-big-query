...
> **Status:** ✅ Deployed to production 2026-08-22, currently returning 0 rows (benign — no real jobs have run through this line grouping yet) · **Category:** Production · **Runs:** rides the Work Orders pipeline, 7:20 PM / 7:30 PM Mountain (prod/test)
