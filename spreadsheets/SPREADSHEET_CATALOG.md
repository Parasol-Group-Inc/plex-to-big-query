...
| [Bottling Job Schedule](https://docs.google.com/spreadsheets/d/1m6ZmBMBCQHTsc4S7W-FicIaE63AOfxvobbnEDRwmqAk/edit) | Google Sheet | Scheduling bottling jobs | Production, Planning, Sales | — (same views as MFG Job Schedule) | ✅ Built 2026-08-22, deployed to prod+test, incl. exploratory Run Time/# Completed reconstruction, not yet verified against real data | [bottling_job_schedule.md](bottling_job_schedule.md) |
| [Packaging Daily Report](https://docs.google.com/spreadsheets/d/14Qazm-rH26O66BLcnVZi5GahsPQ-TL5P2WLlSG6eFJc/edit) | Google Sheet | Daily Numbers Report | Production, Planning | `Part_v_Production` by `Workcenter_Group='Bottling'` (Daily Shifts UI-report lead) | ✅ Built (Actual+Employee+Scrap) — deployed to PlexTest 2026-08-21, promoted to prod GCS config 2026-08-22 (live on next scheduled prod run), 0 rows (no job has run yet on this tenant, benign, see doc) | [packaging_daily_report.md](packaging_daily_report.md) |
| [Labeling Daily Report](https://docs.google.com/spreadsheets/d/1gVZe3_8wbexYIiQNtYdtCCvsJqUgj7zXrdTzVXl8XLI/edit) | Google Sheet | Daily Numbers Report | Production, Planning | `Part_v_Production` by `Workcenter_Group='Labeling'` (Daily Shifts UI-report lead) | ✅ Built (Actual+Employee+Scrap) — deployed to PlexTest 2026-08-21, promoted to prod GCS config 2026-08-22 (live on next scheduled prod run), 0 rows (no job has run yet on this tenant, benign, see doc) | [labeling_daily_report.md](labeling_daily_report.md) |
| [Blending Daily Report](https://docs.google.com/spreadsheets/d/1NyJOe2PUyNElJkHz1kYknGGQC8fKaFd9l32nPFJJjNQ/edit) | Google Sheet | Daily Numbers Report / Scheduling | Production, Planning | `Part_v_Production` by `Workcenter_Group IN ('Blending','Pre-Weigh')` (Daily Shifts UI-report lead) | ✅ Built (Actual+Employee+Scrap) — deployed to PlexTest 2026-08-21, promoted to prod GCS config 2026-08-22 (live on next scheduled prod run), 0 rows (no job has run yet on this tenant, benign, see doc) | [blending_daily_report.md](blending_daily_report.md) |
| [Encap Daily Report](https://docs.google.com/spreadsheets/d/105iiQ_fFqNRg_6hpP0nI5CreuKeKL35bk2piIO2Gd5c/edit) | Google Sheet | Encap Scheduling / Planning | Production, Planning | `Part_v_Production` by `Workcenter_Group='Encapsulating'` (Daily Shifts UI-report lead) | ✅ Built (Actual+Employee+Scrap) — deployed to PlexTest 2026-08-21, promoted to prod GCS config 2026-08-22 (live on next scheduled prod run), 0 rows (no job has run yet on this tenant, benign, see doc) | [encap_daily_report.md](encap_daily_report.md) |
| Weekly Production Update | Google Sheet | Weekly/Monthly Production Attainment | Production, Planning | `Part_v_Production` grouped by department/week-to-date/month-to-date (same source as the 4 Daily Reports) | 🚧 Partially built 2026-08-26 — Actual WTD/MTD qty + % of month complete only; Goal/% of Goal and the whole Capacity tab deliberately left unbuilt (no Plex source / no confirmed formula) | [weekly_production_update.md](weekly_production_update.md) |
