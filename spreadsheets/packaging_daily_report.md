...
- **Status:** ✅ Deployed to test 2026-08-21 (Actual half only), promoted to prod GCS config 2026-08-22, 0 rows, decided Bottling mapping — `packaging_daily_report` (`reports/work_orders.yaml`)
